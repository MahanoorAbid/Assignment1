...
function checkUsernames() {
    // Current users list
    const current_users = ['John', 'Harry', 'Amna', 'Alice', 'Michael'];
    // New users list
    const new_users = ['RobErT', 'Mary', 'Mike', 'Steven', 'ALICE'];
    // Convert all current usernames to lowercase for case-insensitive comparison
    const current_users_lower = current_users.map((username) => username.toLowerCase());
